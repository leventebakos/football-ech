...
def league_details(request, id):
    ...
    group_G_matches = get_group_matches("G", league, request)
    group_H_matches = get_group_matches("H", league, request)
    ...
    group_G_header = get_group_headers("G")
    group_H_header = get_group_headers("H")
